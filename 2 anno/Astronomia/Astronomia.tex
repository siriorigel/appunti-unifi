...
e a destra l'Ovest. \\
l sistema di (due) coordinate più
...
considerano l’equatore celeste
(contiene l’equatore terrestre) o
l’eclittica (contiene l’orbita della
Terra). L’asse terrestre (N-S) ha
inclinazione (quasi) fissa, i punti di
intersezione tra eclittica ed
equatore celeste si dicono vernali
(quello di primavera è il punto
\textbf{gamma}). Coordinate astronomiche
...
\begin{itemize}
    \item \textbf{Azimut}: coordinate rispetto all'asse Sud-Nord: ossia la differenza
    angolare rispetto al Nord ($0 \sim 360$°)
    \item \textbf{Altezza}: coordinata rispetto all'orizzonte ($-90$°$\sim 90$°).
\end{itemize}
I telescopi semplici (e anche quelli grandi), sono altoazimutali. 
...
\begin{itemize}
    \item \textbf{Declinazione} $\delta$: la differenza angolare rispetto al cerchio fondamentale
    (l'equatore celeste);
    \item \textbf{Ascensione retta} $\alpha$: declinazione angolare rispetto al meridiano di Greenwich 
    sulla sfera celeste. 
\end{itemize}
...
\end{figure} 
\noindent
Dati due punti Q e Q’, il percorso più breve (geodetica) che li 
...
di superficie sferica dal centro della sfera:
\begin{align}
    \Omega = \frac{A}{r^{2}}
\end{align}
...
analogo posso definire gli angoli $\phi'$ e $\theta'$ per esprimere la posiione del punto $P$
...
del triangolo sferico, secondo il seguente disegno:
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35\textwidth]{coordinate sferiche.png}
\end{figure}
...
mentre il vertice $C$ corrisponde al punto $P$. $\phi, \theta, \phi', \theta', \chi$ 
...
\end{gather*}
Quando $a, b, c \to 0$m si ritrovano i teoremi per i triangoli piani nello spazio Euclideo. 
