...
emettere energia sottoforma di radiazione elettromagnetica. Il
secondo postulato di Bohr afferma che l'elettrone può saltare da un orbita 
...
Ai tempi dei romani, chi riusciva a distinguere, veniva arruolato nell'esercito romano
come arciere.
...
\begin{itemize}
    ...
    \item \textbf{Doppler shift}: questo metodo utilizza l'effetto Doppler nella stella del sistema indotta dall'attrazione
    gravitazionale del pianeta, dipendendo dalle velocità radiali: l'entità
    dell'effetto Doppler permette di definire la massa del pianeta. Questo metodo 
    è efficiente se i pianeti sono massicci ed orbitano vicino alla stella. (Nel caso del Sole e di Giove, 
    il loro centro di massa giace poco fuori dal volume del Sole).
