...
\begin{proof}
    ...
    \begin{center}
        ...
        \node[align=left, draw, fill=page, font=\small] at (2.5,-0.5) {
            ...
            $f(P') = \int_{\gamma} \omega + \int_{\phi} \omega$ \\
            $\Delta f = \int_{\phi} \omega$
        };
        \end{tikzpicture}
    \end{center}
    ...
    \end{gather*}
    Se chiamo $P(h) = \int_{0}^{h} a_1(x_1+t,x_2,x_3) dt$ per il t.f.c.i. $P$ è derivabile e $P'(t) = a_1(x_1+t,x_2,x_3)$ ovvero l'integranda\\
...
\begin{proof}%ho messo nabla al posto di d
    Se $\omega$ è esatta, $\omega = \nabla f$, cioè $a_1 = \frac{\partial f}{\partial x_1} \quad a_2 = \frac{\partial f}{\partial x_2} \quad a_3 = \frac{\partial f}{\partial x_3}   $\\
...
\begin{theorem}[chiusa su un simpl. conn. implica esatta]
...
\begin{definition}
  ...
  \end{gather*}
  E se il limite converge ad una funzione chiameremo questa $S(x)$
\end{definition}
...
\begin{proof}
  ...
  $I_\eta = [-\eta, \eta] \in I_\xi \qquad$ con $I_\xi = [-|\xi|, |\xi|]$\\
