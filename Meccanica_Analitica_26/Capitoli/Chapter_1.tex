\section{Vettori in $\mathbb{R}^3$}\label{sec:1_vettori}
...
La distanza $d=|P-O|\sin(\alpha)$ è la distanza tra il polo $O$ e la retta su cui è applicato il vettore $\vec v$ ed è detta \textbf{